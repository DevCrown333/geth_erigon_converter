...
erigon_output = client.make_request('trace_block', [block_hash])

geth_params = [block_hash, {'tracer': 'callTracer'}]

geth_output_call_tracer = client.make_request('debug_traceBlockByNumber', geth_params)
